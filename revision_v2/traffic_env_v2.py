...
class TrafficSignalEnvV2(gym.Env):
    ...
    def step(
        ...
        step_departed = 0
        step_arrived = 0
        step_teleports_started = 0
        step_teleports_ended = 0
        ...
        for _ in range(
            ...
            step_teleports_started += (
                traci.simulation
                .getStartingTeleportNumber()
            )

            step_teleports_ended += (
                traci.simulation
        ...
        info = {
            ...
            "departed_vehicles": step_departed,
            "arrived_vehicles": step_arrived,
            "teleports_started": step_teleports_started,
            "teleports_ended": step_teleports_ended,
        }
    ...
    def _simulation_second(self):
        """
        Advance SUMO by exactly one simulation second and
        update the controlled yellow/green transition state.

        This helper mirrors the one-second transition logic
        used during normal environment execution and is also
